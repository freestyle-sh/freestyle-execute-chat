...
function Sidebar({
  ...
  const sidebarOpenMobile = openMobile !== undefined ? openMobile : false;
  const sidebarSetOpenMobile = onOpenChangeMobile || (() => {});
  ...
  if (isMobile) {
    return (
      <Sheet open={sidebarOpenMobile} onOpenChange={sidebarSetOpenMobile} {...props}>
        <SheetContent
