    ...
    <div className="flex flex-col items-center min-h-screen p-6 bg-gradient-to-b from-background to-secondary/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mb-8">
            ...
            <div className="mt-4 pt-4 border-t">
              <label className="flex items-center gap-2">
                <input 
                  ...
                  className="rounded"
                />
                <span className="text-sm font-medium">Force Authentication (non-closable)</span>
              </label>
              <p className="text-xs text-muted-foreground mt-1 ml-5">
                When enabled, the popup cannot be dismissed and the "Continue as Guest" button is hidden
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border shadow-sm p-6 animate-slide-up flex flex-col">
          <h2 className="text-lg font-medium mb-4 pb-2 border-b">Demo Options</h2>
          
          <div className="flex flex-col gap-4 flex-1">
            <div className="rounded-lg bg-muted/30 p-4">
              <h3 className="text-sm font-medium mb-2">Standard Popup</h3>
              <p className="text-xs text-muted-foreground mb-4">
                Shows a popup that can be closed with the "X" button, by pressing 
                Escape, by clicking outside, or by using the "Continue as Guest" button.
              </p>
            ...
            <div className="rounded-lg bg-muted/30 p-4">
              <h3 className="text-sm font-medium mb-2">Forced Authentication</h3>
              <p className="text-xs text-muted-foreground mb-4">
                Shows a popup that cannot be closed except by clicking the primary
                action button. No escape key, no clicking outside, no close button.
              </p>
            ...
            <div className="mt-auto pt-4 text-xs text-muted-foreground">
              <p>The forced authentication popup is what will appear when a user has reached their message limit.</p>
            </div>
          </div>
        </div>
      </div>
