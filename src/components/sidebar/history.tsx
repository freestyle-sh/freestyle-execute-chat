...
export function SidebarHistory() {
  ...
  return (
    <SidebarSection label="History" className="flex flex-col">
      <div className="max-h-[calc(5*32px)] overflow-y-auto pr-1 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-sidebar-border hover:scrollbar-thumb-sidebar-accent">
        {isLoading
